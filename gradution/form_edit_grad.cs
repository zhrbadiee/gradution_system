...
namespace gradution
{
    public partial class form_info_grd : Form
    {
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "update Graduates set fname='" + txtbox_fname.Text + "',lname='" + txtbox_lname.Text + "',fathername='" + txtbox_faname.Text + "',birth='" + dateTimeInput_birth.Text + "',shnumber='" + txtbox_shnumber.Text + "',status='" + comboBox_status.Text + "',phon='" + txtbox_phon.Text + "',mobile='" + txtbox_mobile.Text + "',address='" + richTextBox_address.Text + "',study='" + comboBox_study.Text + "',majer='" + txtbox_majer.Text + "',gpa='"+txtbox_gpa.Text+ "',codemeli='"+txtbox_codemeli.Text+ "'where id_grad='" + txtbox_id_grad.Text + "'";
            cmd.Connection = con;
            cmd.ExecuteNonQuery();
            disconnect();
